...
export const CURVE_SPIN_THRESHOLD = 0.2;
export const POINTER_OFFSET_TOUCH = 0.1;
export const POINTER_OFFSET_FINE = 0.01;
export const PADDLE_SCREEN_Y_MIN = 0.45;
export const PADDLE_SCREEN_Y_MAX = 0.9;
export const CONTACT_DEPTH_BASE = 14;
export const CONTACT_DEPTH_MAX = 24;
export const CONTACT_VISUAL_ASSIST = 1.08;
